...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8">
        <div class="flex items-center space-x-4 mb-6">
            ...
            <div>
                <h3 class="text-xl font-bold text-slate-800">Edit Program Bantuan</h3>
                <p class="text-sm text-slate-500">Perbarui rincian program bantuan sosial.</p>
            </div>
        </div>

        <form action="{{ route('bantuan.update', $bantuan->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nama_program" id="nama_program" value="{{ old('nama_program', $bantuan->nama_program) }}" required
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="nominal" id="nominal" value="{{ old('nominal', $bantuan->nominal) }}" required min="0"
            ...
            <div>
                ...
                <input type="date" name="tanggal_penyaluran" id="tanggal_penyaluran" value="{{ old('tanggal_penyaluran', $bantuan->tanggal_penyaluran ? \Carbon\Carbon::parse($bantuan->tanggal_penyaluran)->format('Y-m-d') : '') }}" required
            ...
            <div>
                ...
                <textarea name="keterangan" id="keterangan" rows="4"
                          ...
                          placeholder="Kriteria wajib penerima atau keterangan tambahan mengenai bantuan ini...">{{ old('keterangan', $bantuan->keterangan) }}</textarea>
                @error('keterangan')
                    <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                @enderror
            </div>
