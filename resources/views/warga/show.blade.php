...
<div class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col sm:flex-row items-center gap-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('warga.edit', $warga->id) }}" class="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-xs font-semibold transition flex items-center gap-2">
